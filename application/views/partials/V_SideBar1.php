    ...
    <ul class="nav flex-column">
        <li class="nav-item">
            <a class="nav-link" href="#" id="daftar-baru">
                <strong>
                    <span class="fa fa-user-plus"></span> Master Barang
                </strong>
            </a>
        </li>
        <div id="div-nav-item-child" class="daftar-div-nav-item-child mt-1 mb-1">
            <ul class="nav flex-column">
                <li class="nav-item-child mb-1">
                    <?php if($active == 'kategori_barang'){ ?>
                        <a class="nav-link active" href="#">
                    <?php } else {?>
                        <a class="nav-link" href="<?=base_url('admin/barang/kategori')?>">
                    <?php }?>
                        <strong>
                            Kategori Barang
                        </strong>
                ...
                <li class="nav-item-child">
                    <?php if($active == 'sub_kategori_barang'){ ?>
                        <a class="nav-link active" href="#">
                    <?php } else {?>
                        <a class="nav-link" href="<?=base_url('admin/barang/sub-kategori')?>">
                    <?php }?>
                        <strong>
                            Sub Kategori Barang
                        </strong>
